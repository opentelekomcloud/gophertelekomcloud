...
import (
	...
	"github.com/opentelekomcloud/gophertelekomcloud/openstack/evs/v3/attachments"
...
func CreateVolumeAttachment(t *testing.T, client *golangsdk.ServiceClient, volume *v3.Volume, server *servers.Server) error {
	if testing.Short() {
