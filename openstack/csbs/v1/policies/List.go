...
func List(client *golangsdk.ServiceClient, opts ListOpts) ([]BackupPolicyResponse, error) {
...
func ExtractBackupPolicies(r pagination.Page) ([]BackupPolicyResponse, error) {
