...
type T struct {
	...
	DataSourceUrls interface{} `json:"data_source_urls"`
	EncryptType    int         `json:"encrypt_type"`
	EndTime        interface{} `json:"end_time"`
	EngineJobId    interface{} `json:"engine_job_id"`
	Extra          interface{} `json:"extra"`
	FileAction     string      `json:"file_action"`
	FinishedStep   int         `json:"finished_step"`
	GroupId        string      `json:"group_id"`
	HiveScriptPath interface{} `json:"hive_script_path"`
	Id             string      `json:"id"`
	Info           interface{} `json:"info"`
	Input          string      `json:"input"`
	InputId        interface{} `json:"input_id"`
	IsProtected    interface{} `json:"is_protected"`
	IsPublic       interface{} `json:"is_public"`
	JarPath        string      `json:"jar_path"`
	JobConfigs     interface{} `json:"job_configs"`
	...
	OutputId       interface{} `json:"output_id"`
