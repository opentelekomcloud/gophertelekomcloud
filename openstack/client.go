...
// NewCBR creates a ServiceClient that can be used to access CBR v3 service
func NewCBR(client *golangsdk.ProviderClient, eo golangsdk.EndpointOpts) (*golangsdk.ServiceClient, error) {
