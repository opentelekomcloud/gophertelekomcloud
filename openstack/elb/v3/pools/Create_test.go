...
func TestCreate(t *testing.T) {
	...
	th.Mux.HandleFunc("/pools", func(w http.ResponseWriter, r *http.Request) {
		...
		th.TestJSONRequest(t, r, `{"pool":{"lb_algorithm":"LEAST_CONNECTIONS","protocol":"HTTP","loadbalancer_id":"loadbalancer-id","listener_id":"listener-id","project_id":"project-id","name":"pool-test","description":"pool","session_persistence":{"type":"APP_COOKIE","cookie_name":"session","persistence_timeout":10},"slow_start":{"enable":true,"duration":30},"admin_state_up":true,"member_deletion_protection_enable":false,"vpc_id":"vpc-id","type":"instance"}}`)
