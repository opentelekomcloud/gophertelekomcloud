...
func TestCreateRequest(t *testing.T) {
	...
	created, err := policies.Create(client.ServiceClient(), opts)
...
func TestGetRequest(t *testing.T) {
	...
	policy, err := policies.Get(client.ServiceClient(), expected.Id)
	th.AssertNoErr(t, err)
...
func TestDeleteRequest(t *testing.T) {
	...
	th.AssertNoErr(t, policies.Delete(client.ServiceClient(), id))
}
