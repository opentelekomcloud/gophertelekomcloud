...
func Create(client *golangsdk.ServiceClient, snapshotId string, opts map[string]string) (map[string]string, error) {
	...
	raw, err := client.Post(client.ServiceURL("snapshots", snapshotId, "metadata"), b, nil, &golangsdk.RequestOpts{
		OkCodes: []int{200},
	})
