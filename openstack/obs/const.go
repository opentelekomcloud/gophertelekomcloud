...
const (
	obsSdkVersion       = "3.19.11"
	UserAgent           = "obs-sdk-go/" + obsSdkVersion
	HeaderPrefix        = "x-amz-"
	HeaderPrefixMeta    = "x-amz-meta-"
	HeaderPrefixObs     = "x-obs-"
	HeaderPrefixMetaObs = "x-obs-meta-"
	HeaderDateAmz       = "x-amz-date"
	HeaderDateObs       = "x-obs-date"
	HeaderStsTokenAmz   = "x-amz-security-token"
	HeaderStsTokenObs   = "x-obs-security-token"
	HeaderAccesssKeyAmz = "AWSAccessKeyId"
	PrefixMeta          = "meta-"

	HeaderContentSha256Amz             = "x-amz-content-sha256"
	HeaderAclAmz                       = "x-amz-acl"
	HeaderAclObs                       = "x-obs-acl"
	HeaderAcl                          = "acl"
	HeaderLocationAmz                  = "location"
	HeaderBucketLocationObs            = "bucket-location"
	HeaderCopySource                   = "copy-source"
	HeaderCopySourceRange              = "copy-source-range"
	HeaderRange                        = "Range"
	HeaderStorageClass                 = "x-default-storage-class"
	HeaderStorageClassObs              = "x-obs-storage-class"
	HeaderVersionObs                   = "version"
	HeaderGrantReadObs                 = "grant-read"
	HeaderGrantWriteObs                = "grant-write"
	HeaderGrantReadAcpObs              = "grant-read-acp"
	HeaderGrantWriteAcpObs             = "grant-write-acp"
	HeaderGrantFullControlObs          = "grant-full-control"
	HeaderGrantReadDeliveredObs        = "grant-read-delivered"
	HeaderGrantFullControlDeliveredObs = "grant-full-control-delivered"
	HeaderRequestId                    = "request-id"
	HeaderBucketRegion                 = "bucket-region"
	HeaderAccessConrtolAllowOrigin     = "access-control-allow-origin"
	HeaderAccessConrtolAllowHeaders    = "access-control-allow-headers"
	HeaderAccessConrtolMaxAge          = "access-control-max-age"
	HeaderAccessConrtolAllowMethods    = "access-control-allow-methods"
	HeaderAccessConrtolExposeHeaders   = "access-control-expose-headers"
	HeaderEpidHeaders                  = "epid"
	HeaderVersionId                    = "version-id"
	HeaderCopySourceVersionId          = "copy-source-version-id"
	HeaderDeleteMarker                 = "delete-marker"
	HeaderWebsiteRedirectLocation      = "website-redirect-location"
	HeaderMetadataDirective            = "metadata-directive"
	HeaderExpiration                   = "expiration"
	HeaderExpiresObs                   = "x-obs-expires"
	HeaderRestore                      = "restore"
	HeaderObjectType                   = "object-type"
	HeaderNextAppendPosition           = "next-append-position"
	HeaderStorageClass2                = "storage-class"
	...
	HeaderCopySourceIfMatch           = "copy-source-if-match"
	HeaderCopySourceIfNoneMatch       = "copy-source-if-none-match"
	HeaderCopySourceIfModifiedSince   = "copy-source-if-modified-since"
	HeaderCopySourceIfUnmodifiedSince = "copy-source-if-unmodified-since"
	...
	HeaderSsecEncryption = "server-side-encryption-customer-algorithm"
	HeaderSsecKey        = "server-side-encryption-customer-key"
	HeaderSsecKeyMd5     = "server-side-encryption-customer-key-MD5"

	HeaderSsekmsEncryption    = "server-side-encryption"
	HeaderSsekmsKey           = "server-side-encryption-aws-kms-key-id"
	HeaderSsekmsEncryptKeyObs = "server-side-encryption-kms-key-id"

	HeaderSsecCopySourceEncryption = "copy-source-server-side-encryption-customer-algorithm"
	HeaderSsecCopySourceKey        = "copy-source-server-side-encryption-customer-key"
	HeaderSsecCopySourceKeyMd5     = "copy-source-server-side-encryption-customer-key-MD5"

	HeaderSsekmsKeyAmz = "x-amz-server-side-encryption-aws-kms-key-id"

	HeaderSsekmsKeyObs = "x-obs-server-side-encryption-kms-key-id"

	HeaderSuccessActionRedirect = "success_action_redirect"

	HeaderDateCamel                       = "Date"
	HeaderHostCamel                       = "Host"
	HeaderHost                            = "host"
	HeaderAuthCamel                       = "Authorization"
	HeaderMd5Camel                        = "Content-MD5"
	HeaderLocationCamel                   = "Location"
	HeaderContentLengthCamel              = "Content-Length"
	HeaderContentTypeCaml                 = "Content-Type"
	HeaderUserAgentCamel                  = "User-Agent"
	HeaderOriginCamel                     = "Origin"
	HeaderAccessControlRequestHeaderCamel = "Access-Control-Request-Headers"
	HeaderCacheControlCamel               = "Cache-Control"
	HeaderContentDispositionCamel         = "Content-Disposition"
	HeaderContentEncodingCamel            = "Content-Encoding"
	HeaderContentLanguageCamel            = "Content-Language"
	HeaderExpiresCamel                    = "Expires"

	ParamVersionId                  = "versionId"
	ParamResponseContentType        = "response-content-type"
	ParamResponseContentLanguage    = "response-content-language"
	...
	ParamResponseContentEncoding    = "response-content-encoding"
	ParamImageProcess               = "x-image-process"

	ParamAlgorithmAmzCamel     = "X-Amz-Algorithm"
	ParamCredentialAmzCamel    = "X-Amz-Credential"
	ParamDateAmzCamel          = "X-Amz-Date"
	ParamDateObsCamel          = "X-Obs-Date"
	ParamExpiresAmzCamel       = "X-Amz-Expires"
	ParamSignedheadersAmzCamel = "X-Amz-SignedHeaders"
	ParamSignatureAmzCamel     = "X-Amz-Signature"

	DefaultSignature          = SignatureV2
	...
	Iso8601MidnightDateFormat = "2006-01-02T00:00:00Z"
	Rfc1123Format             = "Mon, 02 Jan 2006 15:04:05 GMT"

	V4ServiceName   = "s3"
	V4ServiceSuffix = "aws4_request"

	V2HashPrefix  = "AWS"
	ObsHashPrefix = "OBS"

	V4HashPrefix = "AWS4-HMAC-SHA256"
	V4HashPre    = "AWS4"

	DefaultSseKmsEncryption    = "aws:kms"
	DefaultSseKmsEncryptionObs = "kms"

	DefaultSseCEncryption = "AES256"
...
const (
	HttpMethodGet     HttpMethodType = HttpGet
	HttpMethodPut     HttpMethodType = HttpPut
	HttpMethodPost    HttpMethodType = HttpPost
	HttpMethodDelete  HttpMethodType = HttpDelete
	HttpMethodHead    HttpMethodType = HttpHead
	HttpMethodOptions HttpMethodType = HttpOptions
)
