...
func TestList(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetListResult)
	})
...
func TestGet(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/54d6f61d-db07-451c-9ab3-b9609b6b6f0b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetGetResult)
	})
...
func TestCreate(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetCreateResult)
	})
...
func TestCreateNoGateway(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetCreateWithNoGatewayResponse)
	})
...
func TestCreateDefaultGateway(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetCreateWithDefaultGatewayResponse)
	})
...
func TestCreateIPv6RaAddressMode(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetCreateWithIPv6RaAddressModeResponse)
	})
...
func TestUpdate(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/08eae331-0402-425a-923c-34f7cfe39c1b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetUpdateResponse)
	})
...
func TestUpdateGateway(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/08eae331-0402-425a-923c-34f7cfe39c1b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetUpdateGatewayResponse)
	})
...
func TestUpdateRemoveGateway(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/08eae331-0402-425a-923c-34f7cfe39c1b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetUpdateRemoveGatewayResponse)
	})
...
func TestUpdateHostRoutes(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/08eae331-0402-425a-923c-34f7cfe39c1b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetUpdateHostRoutesResponse)
	})
...
func TestUpdateRemoveHostRoutes(t *testing.T) {
	...
	//		_,_ = fmt.Fprintf(w, SubnetUpdateRemoveHostRoutesResponse)
	//	})
...
func TestUpdateAllocationPool(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/subnets/08eae331-0402-425a-923c-34f7cfe39c1b", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SubnetUpdateAllocationPoolResponse)
	})
