...
func TestList(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/security-groups", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SecurityGroupListResponse)
	})

	count := 0

	_ = groups.List(fake.ServiceClient(), groups.ListOpts{}).EachPage(func(page pagination.Page) (bool, error) {
		count++
...
func TestCreate(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/security-groups", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SecurityGroupCreateResponse)
	})
...
func TestUpdate(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/security-groups/2076db17-a522-4506-91de-c6dd8e837028",
		func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprintf(w, SecurityGroupUpdateResponse)
		})
...
func TestGet(t *testing.T) {
	...
	th.Mux.HandleFunc("/v2.0/security-groups/85cc3048-abc3-43cc-89b3-377341426ac5", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, SecurityGroupGetResponse)
	})
