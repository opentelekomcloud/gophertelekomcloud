...
type Absolute struct {
	...
	// MaxSecurityGroupRules is the number of security group rules available to a tenant.
	...
	// MaxServerGroupMembers is the number of server group members available to a tenant.
