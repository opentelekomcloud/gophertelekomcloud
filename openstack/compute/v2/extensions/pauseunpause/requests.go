...
func Pause(client *golangsdk.ServiceClient, id string) (r PauseResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"pause": nil}, nil, nil)
	return
}
...
func Unpause(client *golangsdk.ServiceClient, id string) (r UnpauseResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"unpause": nil}, nil, nil)
	return
}
