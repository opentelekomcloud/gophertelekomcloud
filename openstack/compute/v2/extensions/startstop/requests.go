...
func Start(client *golangsdk.ServiceClient, id string) (r StartResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"os-start": nil}, nil, nil)
	return
}

// Stop is the operation responsible for stopping a Compute server.
func Stop(client *golangsdk.ServiceClient, id string) (r StopResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"os-stop": nil}, nil, nil)
	return
}
