...
func Suspend(client *golangsdk.ServiceClient, id string) (r SuspendResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"suspend": nil}, nil, nil)
	return
}
...
func Resume(client *golangsdk.ServiceClient, id string) (r UnsuspendResult) {
	raw, err := client.Post(actionURL(client, id), map[string]interface{}{"resume": nil}, nil, nil)
	return
}
